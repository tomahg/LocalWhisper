...
public sealed partial class DirectTypeCorrectionsPage : Page
{
    private readonly AppSettings _settings;
    private readonly SettingsService _settingsService;
    private CorrectionEntry? _editingEntry;

    public DirectTypeCorrectionsPage()
    {
        InitializeComponent();
    ...
    private void TryAdd()
    {
        ...
        _settings.DirectTypeCorrections.Add(new CorrectionEntry { Wrong = wrong, Correct = correct });
    ...
    private void RebuildList()
    {
        ...
        ListDivider.Visibility = _settings.DirectTypeCorrections.Count > 0
            ? Visibility.Visible
            : Visibility.Collapsed;

        var sorted = _settings.DirectTypeCorrections
    ...
    private UIElement BuildDisplayRow(CorrectionEntry entry)
    {
        ...
        deleteBtn.Click += (_, _) =>
        {
            ...
            _settings.DirectTypeCorrections.Remove(entry);
            _settingsService.Save(_settings);
            RebuildList();
        };
