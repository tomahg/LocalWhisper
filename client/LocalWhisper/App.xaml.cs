...
using LocalWhisper.Helpers;
using LocalWhisper.Models;
using LocalWhisper.Services;
using LocalWhisper.ViewModels;
using static LocalWhisper.Models.TranscriptionSource;
    ...
    private void InitializeTrayIcon()
    {
        ...
        orchestrator.MicrophoneDeviceLost += () =>
        {
            ...
            _dispatcherQueue?.TryEnqueue(() =>
                _trayIcon?.ShowNotification("LocalWhisper",
    ...
    private void UpdateTrayIcon(bool recording, bool connected)
    {
        _dispatcherQueue?.TryEnqueue(() =>
        {
            ...
            _trayIcon.ToolTipText = connected
                ? (recording ? "LocalWhisper – Tar opp..." : "Local Whisper – Tilkoblet")
                : "Local Whisper – Frakoblet";
        });
    }
